...
//func CallGetDatasetFolderStatus() ([]byte, error) {
//
//	accessToken, err := getAccessToken("files", "service.files", []string{"GetDatasetFolderStatus"})
//	if err != nil {
...
//
//	bodyReader := bytes.NewReader(requestBytes)
//	requestUrl := "http://" + OsSystemServer + "/system-server/v1alpha1/files/service.files/v1/GetDatasetFolderStatus"
//
//	fmt.Println(requestUrl)
//	req, err := http.NewRequest(http.MethodPost, requestUrl, bodyReader) //, bodyReader)
//
//	if err != nil {
//		fmt.Println("client: could not create request: ", err)
//		return nil, err
